  ...
  SHOP_ITEMS: [
    {
      id: 'bomb_small',
      name: 'Knaller',
      description: 'Legt einen Bereich von 40m frei',
      cost: 700,
      icon: '🧨',
      type: 'bomb',
      bombRadius: 40,
    },
    {
      id: 'bomb_medium',
      name: 'Bombe',
      description: 'Legt einen Bereich von 75m frei',
      cost: 2000,
      icon: '💣',
      type: 'bomb',
      bombRadius: 75,
    },
    {
      id: 'bomb_mega',
      name: 'Atom Bombe',
      description: 'Legt einen Bereich von 130m frei',
      cost: 12000,
      icon: '☢️',
      type: 'bomb',
      bombRadius: 130,
    },
    {
      ...
      description: 'Legt einen Bereich von 350m frei',
      cost: 250000,
      icon: '💀',
      type: 'bomb',
      bombRadius: 350,
